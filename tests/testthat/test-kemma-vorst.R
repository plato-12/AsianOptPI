# Test suite for Kemma-Vorst implementation

test_that("Kemma-Vorst geometric average gives positive prices", {
  price <- price_kemma_vorst_geometric(
...
test_that("Kemma-Vorst geometric: call price increases with volatility", {
  price_low_vol <- price_kemma_vorst_geometric(
    100, 100, 0.05, 0.1, 0, 1, "call"
  )
  price_high_vol <- price_kemma_vorst_geometric(
...
test_that("Kemma-Vorst geometric: call price decreases with strike", {
  price_low_K <- price_kemma_vorst_geometric(
    100, 90, 0.05, 0.2, 0, 1, "call"
  )
  price_high_K <- price_kemma_vorst_geometric(
...
test_that("Kemma-Vorst geometric: put price increases with strike", {
  price_low_K <- price_kemma_vorst_geometric(
...
test_that("Kemma-Vorst geometric: zero volatility gives intrinsic value", {
  # At-the-money with zero volatility
  price_call <- price_kemma_vorst_geometric(
    100, 100, 0.05, 0, 0, 1, "call"
  )
  price_put <- price_kemma_vorst_geometric(
...
test_that("Kemma-Vorst geometric: deep ITM call approaches forward price", {
...
test_that("Kemma-Vorst geometric: input validation", {
  expect_error(
    price_kemma_vorst_geometric(-100, 100, 0.05, 0.2, 0, 1, "call"),
  ...
  expect_error(
    price_kemma_vorst_geometric(100, 100, 0.05, 0.2, 1, 0, "call"),
    "T must be greater than T0"
  )
  expect_error(
    price_kemma_vorst_geometric(100, 100, 0.05, 0.2, 0, 1, "invalid"),
    "'arg' should be one of"
  )
})

test_that("Kemma-Vorst geometric binomial version works", {
  price <- price_kemma_vorst_geometric_binomial(
    S0 = 100, K = 100, r = 1.05,
    u = 1.2, d = 0.8, n = 10
  )
...
test_that("Kemma-Vorst geometric binomial: validation", {
  expect_error(
    price_kemma_vorst_geometric_binomial(100, 100, 1.05, 0.9, 0.8, 10),
    "u must be greater than 1"
  )
  expect_error(
    price_kemma_vorst_geometric_binomial(100, 100, 1.05, 1.2, 1.1, 10),
    "d must be less than 1"
  )
})

test_that("Kemma-Vorst arithmetic Monte Carlo works", {
...
test_that("Kemma-Vorst arithmetic with diagnostics returns list", {
  result <- price_kemma_vorst_arithmetic(
    S0 = 100, K = 100, r = 0.05, sigma = 0.2,
    T0 = 0, T = 1, n = 10, M = 1000,
...
test_that("Kemma-Vorst arithmetic: control variate reduces variance", {
  set.seed(123)
  result_with <- price_kemma_vorst_arithmetic(
    100, 100, 0.05, 0.2, 0, 1, 10, 5000,
    use_control_variate = TRUE, return_diagnostics = TRUE, seed = 123
  )

  set.seed(123)
  result_without <- price_kemma_vorst_arithmetic(
    100, 100, 0.05, 0.2, 0, 1, 10, 5000,
...
test_that("Kemma-Vorst arithmetic: correlation is high", {
  result <- price_kemma_vorst_arithmetic(
...
test_that("Kemma-Vorst arithmetic: bounded by geometric", {
  # Arithmetic average >= geometric average (AM-GM inequality)
  # So arithmetic call option >= geometric call option

  geom_price <- price_kemma_vorst_geometric(
    100, 100, 0.05, 0.2, 0, 1, "call"
  )

  arith_price <- price_kemma_vorst_arithmetic(
...
test_that("Kemma-Vorst arithmetic: prices increase with volatility", {
  price_low <- price_kemma_vorst_arithmetic(
    100, 100, 0.05, 0.1, 0, 1, 20, 5000, seed = 123
  )

  price_high <- price_kemma_vorst_arithmetic(
...
test_that("Kemma-Vorst arithmetic: call decreases with strike", {
  price_low_K <- price_kemma_vorst_arithmetic(
    100, 90, 0.05, 0.2, 0, 1, 20, 5000, seed = 123
  )

  price_high_K <- price_kemma_vorst_arithmetic(
...
test_that("Kemma-Vorst arithmetic: put increases with strike", {
  price_low_K <- price_kemma_vorst_arithmetic(
...
test_that("Kemma-Vorst arithmetic: input validation", {
  expect_error(
    price_kemma_vorst_arithmetic(-100, 100, 0.05, 0.2, 0, 1, 10, 1000),
    "S0 must be a positive number"
  )
  expect_error(
    price_kemma_vorst_arithmetic(100, -100, 0.05, 0.2, 0, 1, 10, 1000),
  ...
  expect_error(
    price_kemma_vorst_arithmetic(100, 100, 0.05, 0.2, 1, 0, 10, 1000),
    "T must be greater than T0"
  )
  expect_error(
    price_kemma_vorst_arithmetic(100, 100, 0.05, 0.2, 0, 1, -5, 1000),
    "n must be a positive integer"
  )
  expect_error(
    price_kemma_vorst_arithmetic(100, 100, 0.05, 0.2, 0, 1, 10, -100),
    "M must be a positive integer"
  )
})

test_that("Kemma-Vorst arithmetic: warns for small M", {
  expect_warning(
    price_kemma_vorst_arithmetic(100, 100, 0.05, 0.2, 0, 1, 10, 500),
    "M = 500 is very small"
  )
})

test_that("Kemma-Vorst arithmetic binomial version works", {
...
test_that("Kemma-Vorst arithmetic binomial: validation", {
  expect_error(
    price_kemma_vorst_arithmetic_binomial(100, 100, 1.05, 0.9, 0.8, 10, 1000),
    "u must be greater than 1"
  )
  expect_error(
    price_kemma_vorst_arithmetic_binomial(100, 100, 1.05, 1.2, 1.1, 10, 1000),
    "d must be less than 1"
  )
})

test_that("Kemma-Vorst print and summary methods work", {
  result <- price_kemma_vorst_arithmetic(
  ...
  # Test print
  expect_output(print(result), "Kemma-Vorst Arithmetic Asian Option")
  expect_output(print(result), "Estimated Price")
  expect_output(print(result), "Standard Error")
  expect_output(print(result), "95% CI")

  # Test summary
  expect_output(summary(result), "Kemma-Vorst Arithmetic Asian Option")
})

test_that("Kemma-Vorst: reproducibility with seed", {
  result1 <- price_kemma_vorst_arithmetic(
    100, 100, 0.05, 0.2, 0, 1, 10, 1000, seed = 456
  )

  result2 <- price_kemma_vorst_arithmetic(
    100, 100, 0.05, 0.2, 0, 1, 10, 1000, seed = 456
  )
...
test_that("Kemma-Vorst: comparison with example from paper", {
